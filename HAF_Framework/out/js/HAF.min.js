...
}}function g(m,k){d("#"+m).addClass("page-visible");d("a[href$='#/"+m+"']").addClass("selected");var l=c[m];if(l){if(l.moduleItem){location.replace("#/"+m+"/"+l.module+"/"+l.moduleItem);}}a.messaging.publish("navigationChangedTo:"+e,k);}function i(l){var k=l.substr(1).split("/");return{path:l,page:k[1],module:k[2],moduleItem:k[3]};
