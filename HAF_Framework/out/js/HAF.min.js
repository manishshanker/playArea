...
}function i(n,o){var m=new RegExp(n.replace("?",".").replace(/:[a-zA-Z0-9]+/g,function(p){return"([a-zA-Z0-9]+)";})).exec(b);if(m){m.splice(0,1);o.apply(null,m);}}return{load:l,route:i};};a.navigation=new c();}(HAF,HAF.DOM));(function(b,d){b.templateEngine={getById:f,getByCSSSelector:c,getByURL:a,process:e};
