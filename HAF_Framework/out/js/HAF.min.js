...
},updated:function(f){var g,e;var d=a[this.guid()];d.lastResult=f;if(d){for(g=0,e=d.updateCallBack.length;g<e;g++){d.updateCallBack[g](f);}}},destroy:function(){delete a[this.guid()];},stop:b.noop,start:b.noop});}(HAF,HAF.DOM));(function(a){var b={};a.TemplateByString=function(e){return new a.Template(e,a.Template.LOAD.BY_STRING);
};a.TemplateByID=function(e){return new a.Template(e,a.Template.LOAD.BY_ID);};a.TemplateByURL=function(e){return new a.Template(e,a.Template.LOAD.BY_URL);};a.TemplateSafeString=function(e){return new a.templateEngine.safeString(e);};a.Template=a.Base.extend({init:function(e,f){this.path=e;this.loadBy=f||a.Template.LOAD.DEFAULT;
},process:function(e){if(this.path===undefined){return"";}if(!b[this.guid()]){console.log("Template param: ",this.path,this.loadBy);throw new Error("Template not in cache!!");}return a.templateEngine.process(b[this.guid()],e);},load:function(g){var e=this;if(this.path===undefined||b[this.guid()]){g();
}else{if(e.loadBy===a.Template.LOAD.BY_URL){var f=d(c(a.Template.LOAD.BY_URL_DEFAULT_PATH)+e.path);a.templateEngine.getByURL(f,function(h){b[e.guid()]=h;g.call(e);});}else{if(this.loadBy===a.Template.LOAD.BY_ID){b[this.guid()]=a.templateEngine.getById(this.path);a.templateEngine.remove(this.path);setTimeout(function(){g.call(e);
},5);}else{b[this.guid()]=a.templateEngine.getByString(this.path);setTimeout(function(){g.call(e);},5);}}}},destroy:function(){delete b[this.guid()];}});function d(e){return e+(/\.[a-z]{3,4}$/.test(e)?"":a.Template.LOAD.BY_URL_DEFAULT_EXTENSION);}function c(e){return e+(/\/$/.test(e)?"":"/");}a.Template.LOAD={BY_ID:"APP_TEMPLATE_BY_ID",BY_URL:"APP_TEMPLATE_BY_URL",BY_STRING:"APP_TEMPLATE_BY_STRING",DEFAULT:"APP_TEMPLATE_BY_ID",BY_URL_DEFAULT_PATH:"",BY_URL_DEFAULT_EXTENSION:".hbs"};
}(HAF));(function(d,f){d.View=d.Base.extend({autoManageEventBind:false,autoLayout:false,init:function(i){this.injectDependencies(i);this.$container=f(this.container);this.$el=this.$container.$item;if(!this.autoManageEventBind){this.bind();}b(this);},container:null,$container:null,bindings:null,layoutChange:d.noop,bind:function(){h(this);
