...
}var j=(i&&i.inject)||(h.inject&&h.inject());b.each(j,function(k,l){h[l]=k;});}function c(){return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a();}function a(){return Math.floor((1+Math.random())*65536).toString(16).substring(1);}function f(){}}(HAF));(function(g){g.Controller=g.Base.extend({autoWire:false,autoDestroy:false,autoShowHide:false,autoLoadControls:false,autoLayout:false,messages:null,injectMessageBus:false,inject:null,routes:{},serviceUpdate:{},init:function(s){if(this.injectMessageBus){this.messageBus=new g.Messaging();
