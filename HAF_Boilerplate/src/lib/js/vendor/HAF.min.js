...
b.infoLogger("messageBus._____create",this.guid);};d.prototype={publish:function(g,h){b.infoLogger("messageBus.____publish",this.guid,g,h);this.localMessageBus.trigger(g,[h]);},subscribe:function(i,g,h){if(typeof i==="string"){g=i;h=g;i=window;}b.infoLogger("messageBus.__subscribe",this.guid,g);var j=this;
